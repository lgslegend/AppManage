...
public class BackupRestoreHelper
{
    ...
    public static int backup(Context context, File backupDir, AppInfo appInfo, ShellCommands shellCommands, int backupMode)
    {
        ...
        {
            ret = shellCommands.backupSpecial(backupSubDir, appInfo.getLabel(),context,appInfo,appInfo.getFilesList());
            appInfo.setBackupMode(AppInfo.MODE_DATA);
        }
        else
        {
            ret = shellCommands.doBackup(context, backupSubDir, appInfo.getLabel(), appInfo.getDataDir(), appInfo.getSourceDir(), backupMode,appInfo);
